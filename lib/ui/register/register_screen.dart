...
class _RegisterPageState extends State<RegisterPage> {
  ...
  String? selectedDropItem = 'موظف';
  List<String> dropDownItems = ['موظف', 'مستخدم'];
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage('assets/ui/home/slide_2.jpeg'), fit: BoxFit.contain),
        ),
      ),
    );
  }
